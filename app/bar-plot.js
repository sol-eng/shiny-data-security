// !preview r2d3 data= data.frame(label = c("Austin Bergstrom Intl", "Chicago Ohare Intl", "Dallas Fort Worth Intl", "Eagle Co Rgnl", "Fort Lauderdale Hollywood Intl", "General Edward Lawrence Logan Intl"), y = c(365, 1455, 7257,  103,  1000,  274), x = c("GPT", "GPT", "GPT","GPT","GPT","GPT"), y_label = c(1, 2, 3,  4,  5,  6), fill = c("red", "blue", "orange", "lightgray", "green", "lightblue"))
...
totals.transition()
  .duration(1000)
      ...
      .attr('y', function(d, i) { return i * col_heigth() + (col_heigth() / 2) + col_top(); })
      .attr("d", function(d) { return d.x; })
      .text(function(d) {return d.yy_label; });
